...
export class migrationNameHere1615681312342 implements MigrationInterface {
    name = 'migrationNameHere1615681312342'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "videos" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL, "link" character varying NOT NULL, "actividadId" integer, CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "actividades_entraclases" ADD CONSTRAINT "FK_d5d5fa1cf525495947cbbdf19cf" FOREIGN KEY ("actividadId") REFERENCES "actividades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "actividades_entraclases" DROP CONSTRAINT "FK_d5d5fa1cf525495947cbbdf19cf"`);
